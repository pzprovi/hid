...
ROM BYTE configDescriptor1[]=
{
    ...
    DESC_CONFIG_WORD(HID_RPT01_SIZE),//63),   //sizeof(hid_rpt01),      // Size of the report descriptor
...
} sd002 =
{
	sizeof(sd002),
	USB_DESCRIPTOR_STRING,
	{'V','o','l','u','m','e',' ','M','a','s','t','e','r'}
};

//Class specific descriptor - HID Consumer
ROM struct
{
